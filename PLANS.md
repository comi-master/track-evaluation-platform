...
The only active delivery route contains seven milestones, numbered 0-6. Milestones 0-4 are complete; milestone 5 has not started. Business closure takes priority over accumulating infrastructure components.
