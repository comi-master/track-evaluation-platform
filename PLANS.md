...
The only active delivery route contains seven milestones, numbered 0-6. Milestones 0, 1 and 2 are complete; milestone 3 has not started. Business closure takes priority over accumulating infrastructure components.
