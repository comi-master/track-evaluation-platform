...
The only active delivery route contains seven milestones, numbered 0-6. Milestones 0-3 are complete; milestone 4 is next and has not started. Business closure takes priority over accumulating infrastructure components.
